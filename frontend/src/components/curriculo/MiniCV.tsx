        ...
        <div className="flex-1 flex flex-col-reverse gap-6 md:flex-row lg:flex-col-reverse xl:flex-row items-center md:items-start lg:items-center xl:items-start bg-black border border-zinc-800 rounded-2xl px-6 pt-6">
            ...
            <div className="flex flex-col gap-5 self-center py-6 items-center md:items-start lg:items-center xl:items-start">
                ...
                <p className="text-sm text-center md:text-left lg:text-center xl:text-left">
                    Sou apaixonado por tecnologia desde os 10 anos e comecei programando blogs com HTML, CSS e JavaScript. Atualmente, foco no
                    desenvolvimento full stack com React, TypeScript e Node.js. Formado em Engenharia de Computação, desenvolvi soluções que
                    agregaram valor às empresas onde atuei. Busco minha primeira oportunidade como desenvolvedor fullstack para aplicar minhas
                    habilidades, evoluir e gerar impacto.
                </p>
            </div>
        </div>
    )
